// Descripción: Pantalla de Registrar Egreso
// Autor: Piero Poblete
...
class RegistrarEgresoScreen extends StatefulWidget {
  const RegistrarEgresoScreen({super.key});

  @override
  State<RegistrarEgresoScreen> createState() => _RegistrarEgresoScreenState();
}

class _RegistrarEgresoScreenState extends State<RegistrarEgresoScreen> {
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: AppColors.rojo, width: 2.0),
                ),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text("Seleccionar", style: TextStyle(color: AppColors.negro)),
                ),
              ],
            ),
